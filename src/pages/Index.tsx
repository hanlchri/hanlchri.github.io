  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-12 sm:mt-20 w-full max-w-6xl px-4">
          ...
          <Link to="/contact" className="floating-card group sm:col-span-2 lg:col-span-1">
