  ...
  return (
    <Layout>
      <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
        <h1 ref={titleRef} className="text-6xl md:text-8xl font-bold mb-6 tech-text animate-float">
          Hanley's Hood
        </h1>
        <div className="max-w-3xl mx-auto">
          <p className="text-xl md:text-2xl mb-10 text-foreground/90 font-mono">
            <span className="text-tech-cyan">&gt; </span>
            {displayText}
            <span className="animate-blink-caret">_</span>
          </p>
          <Button asChild className="bg-tech-purple hover:bg-tech-purple/80 text-white text-lg py-6 px-8 shadow-lg shadow-tech-purple/20 hover:shadow-tech-purple/40 transition-all">
            <Link to="/about">About</Link>
          </Button>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-20">
          <Link to="/java" className="floating-card group interactive-card" style={{ animationDelay: '0.1s' }}>
          ...
          <Link to="/ap-cs" className="floating-card group interactive-card" style={{ animationDelay: '0.2s' }}>
          ...
          <Link to="/references" className="floating-card group interactive-card" style={{ animationDelay: '0.3s' }}>
          ...
          <Link to="/contact" className="floating-card group interactive-card" style={{ animationDelay: '0.4s' }}>
