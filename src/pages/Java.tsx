              ...
              <div className="space-y-4">
                ...
                <CollapsibleSection title="Unit 4 Looping & Random" titleColor="#FF8C42">
                  <ul className="list-disc pl-6 space-y-1">
                    <li>
                      Looping:
                      <a href="/documents/Java/Lessons/Java_Lesson_Looping_Blank.docx" target="_blank" rel="noopener noreferrer" className="ml-2 hover:text-orange-400 transition-colors" style={{ color: '#FF8C42' }}>Blank</a> |
                      <a href="/documents/Java/Lessons/Java_Lesson_Looping_FilledOut.docx" target="_blank" rel="noopener noreferrer" className="ml-1 hover:text-orange-400 transition-colors" style={{ color: '#FF8C42' }}>Filled</a>
                    </li>
                    <li>
                      Random:
